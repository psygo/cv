...
\renewcommand{\textbf}[1]{{\bfseries\color{accentcolor}#1}}
...
\tagline{
    Quatro anos de experiência profissional, com ferramentas primárias sendo \textbf{NextJS}, \textbf{React}, \textbf{TypeScript} e \textbf{Express}. Também tenho experiência com \textbf{Flutter}, \textbf{SQL}, \textbf{NoSQL} e \textbf{Firebase}. Outras tecnologias com as quais eu sou proficiente: \textbf{React Native}, \textbf{AWS}, \textbf{Lit}, \textbf{Three.js}, and \textbf{Java}. Veja o meu portfólio: \textbf{\href{https://aquarifolio.vercel.app}{@psygo/aquarifolio}}.
}
...
\begin{mainpane}
    ...
    \begin{mainsection}{Outros Projetos}
        ...
        %     [\infoGithub
        %         {@psygo/go-brasil-ranking}
        %         [https://@psygo/go-brasil-ranking]]
        %     [\infoGeneric{\faCalendarDay}{Ago 2022 -- Set 2022}]
        \entryGeneric
            {Livro Técnicas de Go (Jogo de Tabuleiro)}
            [Inteiramente feito com \LaTeX  , e com um pacote personalizado para a criação de diagrams vetoriais com TikZ/PGF.]
            [\infoGithub
