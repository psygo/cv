...
\definecolor{text}{HTML}{2b2b2b} % 2b2b2b Main document font colour, off-black
\definecolor{headings}{HTML}{701112} % 701112 Dark red colour for headings
\definecolor{shade}{HTML}{F5DD9D} % F5DD9D Peach colour for the contact information box
\definecolor{linkcolor}{HTML}{641c1d} % 641c1d 25% desaturated headings colour for links
